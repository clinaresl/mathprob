  ...
  \noindent\begin{minipage}{0.20\linewidth}
    \begin{center}
      \begin{tikzpicture}
        ...
        \coordinate (anc1) at ($(label1) + (1.0*\zerowidth, 0.0)$);
        \fill [black] (anc1) circle (2pt);

        \coordinate (anc3) at ($(anc1) + (3*\zerowidth, 0.0)$);
        \fill [black] (anc3) circle (2pt);
  ...
  \noindent\begin{minipage}{0.20\linewidth}
    \begin{center}
      \begin{tikzpicture}
        ...
        \coordinate (anc1) at ($(label1) + (1.5*\zerowidth, 0.0)$);
        \fill [black] (anc1) circle (2pt);

        \coordinate (anc3) at ($(anc1) + (4*\zerowidth, 0.0)$);
        \fill [black] (anc3) circle (2pt);
  ...
  \noindent\begin{minipage}{0.20\linewidth}
    \begin{center}
      \begin{tikzpicture}
        ...
        \coordinate (anc1) at ($(label1) + (2.5*\zerowidth, 0.0)$);
        \fill [black] (anc1) circle (2pt);

        \coordinate (anc3) at ($(anc1) + (5*\zerowidth, 0.0)$);
        \fill [black] (anc3) circle (2pt);
